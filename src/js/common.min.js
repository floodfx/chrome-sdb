(function(){var SimpleDB,__indexOf=[].indexOf||function(b){for(var a=0,c=this.length;a<c;a++)if(a in this&&this[a]===b)return a;return-1};
...
{DomainName:a}),function(f){return c(f)})};return b}();var SHA1;
...
for(d in e)o.push(d);return o}();h.sort(c);j=function(){var o,s,u;u=[];o=0;for(s=h.length;o<s;o++){d=h[o];u.push(""+d+e[d])}return u}();return SHA1.b64_hmac_sha1(g,j.join(""))};return a}();var Settings;
...
{},true)};b["delete"]=function(a){var c,f,i,e,g;i=b.find_all();f=[];c=e=0;for(g=i.length;0<=g?e<g:e>g;c=0<=g?++e:--e)i[c].get_name()!==a&&f.push(i[c]);return Storage.set("chrome-sdb.profiles",b.profiles_json(f),true)};return b}();})();
