...
a),function(i,e){var g,d,h;i.error!=null&&c(i);h=[];d={};$("Item",e).each(function(){var j;j={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var o,t;o=$("Name",$(this)).text();d[o]=o;t=$("Value",$(this)).text();j.attrs[o]||(j.attrs[o]=[]);return j.attrs[o].push(t)});return h.push(j)});i.items=h;i.attr_names=function(){var j;j=[];for(g in d)j.push(g);return j}();i.next_token=$("NextToken",e).text();return c(i)})};b.prototype.get_attributes=function(a,c,f,i){var e;
if(f==null)f=this.default_callback;if(i==null)i=[];c={DomainName:a,ItemName:c};a=0;for(e=i.length;0<=e?a<e:a>e;0<=e?a++:a--)c["AttributeName."+a]=i[a];return this.ajax_request(this.build_request_url("GetAttributes",c),function(g,d){var h;g.error!=null&&f(g);h={};$("Attribute",d).each(function(){var j,o;j=$("Name",$(this)).text();o=$("Value",$(this)).text();h[j]||(h[j]=[]);return h[j].push(o)});g.attributes=h;return f(g)})};b.prototype.put_attributes=function(a,c,f,i){var e,g,d,h,j,o,t;if(i==null)i=
this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=f.length;h<o;h++){a=f[h];e=a.values;j=0;for(t=e.length;j<t;j++){d=e[j];g["Attribute."+c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;if(a.replace&&a.replace===true)g["Attribute."+c+".Replace"]=true;c+=1}}return this.ajax_request(this.build_request_url("PutAttributes",g),function(u){return i(u)})};b.prototype.delete_attributes=function(a,c,f,i){var e,g,d,h,j,o,t;if(i==null)i=this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=
f.length;h<o;h++){a=f[h];if(e=a.values){j=0;for(t=e.length;j<t;j++){d=e[j];g["Attribute."+c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;c+=1}}else{g["Attribute."+c+".Name"]=a.name;c+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",g),function(u){return i(u)})};b.prototype.batch_delete_attributes=function(a,c,f){var i,e,g,d,h,j,o,t,u,s,l;if(f==null)f=this.default_callback;d={DomainName:a};a=0;for(s=c.length;0<=s?a<s:a>s;0<=s?a++:a--){i=c[a];e=i.item_name;d["Item."+a+".ItemName"]=
e;e=0;l=i.item_attrs;j=0;for(t=l.length;j<t;j++){i=l[j];if(g=i.values){o=0;for(u=g.length;o<u;o++){h=g[o];d["Item."+a+".Attribute."+e+".Name"]=i.name;d["Item."+a+".Attribute."+e+".Value"]=h;e+=1}}else{d["Item."+a+".Attribute."+e+".Name"]=i.name;e+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",d),function(m){return f(m)})};b.prototype.batch_put_attributes=function(a,c,f){var i,e,g,d,h,j,o,t,u,s,l;if(f==null)f=this.default_callback;d={DomainName:a};a=0;for(s=c.length;0<=
s?a<s:a>s;0<=s?a++:a--){i=c[a];e=i.item_name;d["Item."+a+".ItemName"]=e;e=0;l=i.item_attrs;j=0;for(t=l.length;j<t;j++){i=l[j];g=i.values;o=0;for(u=g.length;o<u;o++){h=g[o];d["Item."+a+".Attribute."+e+".Name"]=i.name;d["Item."+a+".Attribute."+e+".Value"]=h;if(i.replace&&i.replace===true)d["Item."+a+".Attribute."+e+".Replace"]=true;e+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",d),function(m){return f(m)})};b.prototype.create_domain=function(a,c){if(c==null)c=this.default_callback;
return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),function(f){return c(f)})};b.prototype.delete_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",{DomainName:a}),function(f){return c(f)})};return b}();var Storage;
