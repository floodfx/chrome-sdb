...
c,true);if(b.primary()===null||a)this.make_primary();return this};b.prototype["delete"]=function(){b["delete"](this.name);return null};b.prototype.to_json=function(){return{name:this.name,settings:this.settings.to_json()}};b.primary=function(){var a;a=Storage.get("chrome-sdb.primary-profile");return b.find(a)};b.from_json=function(a){return a?new b(a.name,Settings.from_json(a.settings)):null};b.find_all=function(){var a;return(a=Storage.get("chrome-sdb.profiles",true))!=null?a:{}};b.find=function(a){var c,
f,j;f=b.find_all();for(c in f){j=f[c];if(a===c)return new b(c,Settings.from_json(j))}return null};b["delete"]=function(a){var c;c=b.find_all();delete c[a];return Storage.set("chrome-sdb.profiles",c,true)};return b}();
...
Date.prototype.getWeekOfYear=function(b){var a=this.getFullYear(),c=this.getMonth(),f=this.getDate();b=b||Date.CultureInfo.firstDayOfWeek;var j=8-(new Date(a,0,1)).getDay();if(j==8)j=1;c=(Date.UTC(a,c,f,0,0,0)-Date.UTC(a,0,1,0,0,0))/864E5+1;c=Math.floor((c-j+7)/7);if(c===b){a--;a=8-(new Date(a,0,1)).getDay();c=a==2||a==8?53:52}return c};Date.prototype.isDST=function(){console.log("isDST");return this.toString().match(/(E|C|M|P)(S|D)T/)[2]=="D"};
...
(function(){Date.Parsing={Exception:function(e){this.message="Parse error at '"+e.substring(0,10)+" ...'"}};for(var b=Date.Parsing,a=b.Operators={rtoken:function(e){return function(g){var d=g.match(e);if(d)return[d[0],g.substring(d[0].length)];else throw new b.Exception(g);}},token:function(){return function(e){return a.rtoken(RegExp("^s*"+e+"s*"))(e)}},stoken:function(e){return a.rtoken(RegExp("^"+e))},until:function(e){return function(g){for(var d=[],h=null;g.length;){try{h=e.call(this,g)}catch(i){d.push(h[0]);
g=h[1];continue}break}return[d,g]}},many:function(e){return function(g){for(var d=[],h=null;g.length;){try{h=e.call(this,g)}catch(i){return[d,g]}d.push(h[0]);g=h[1]}return[d,g]}},optional:function(e){return function(g){var d=null;try{d=e.call(this,g)}catch(h){return[null,g]}return[d[0],d[1]]}},not:function(e){return function(g){try{e.call(this,g)}catch(d){return[null,g]}throw new b.Exception(g);}},ignore:function(e){return e?function(g){var d=null;d=e.call(this,g);return[null,d[1]]}:null},product:function(){for(var e=
arguments[0],g=Array.prototype.slice.call(arguments,1),d=[],h=0;h<e.length;h++)d.push(a.each(e[h],g));return d},cache:function(e){var g={},d=null;return function(h){try{d=g[h]=g[h]||e.call(this,h)}catch(i){d=g[h]=i}if(d instanceof b.Exception)throw d;else return d}},any:function(){var e=arguments;return function(g){for(var d=null,h=0;h<e.length;h++)if(e[h]!=null){try{d=e[h].call(this,g)}catch(i){d=null}if(d)return d}throw new b.Exception(g);}},each:function(){var e=arguments;return function(g){for(var d=
[],h=null,i=0;i<e.length;i++)if(e[i]!=null){try{h=e[i].call(this,g)}catch(o){throw new b.Exception(g);}d.push(h[0]);g=h[1]}return[d,g]}},all:function(){var e=e;return e.each(e.optional(arguments))},sequence:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;if(e.length==1)return e[0];return function(h){for(var i=null,o=null,t=[],u=0;u<e.length;u++){try{i=e[u].call(this,h)}catch(s){break}t.push(i[0]);try{o=g.call(this,i[1])}catch(l){o=null;break}h=o[1]}if(!i)throw new b.Exception(h);if(o)throw new b.Exception(o[1]);
if(d)try{i=d.call(this,i[1])}catch(m){throw new b.Exception(i[1]);}return[t,i?i[1]:h]}},between:function(e,g,d){d=d||e;var h=a.each(a.ignore(e),g,a.ignore(d));return function(i){i=h.call(this,i);return[[i[0][0],r[0][2]],i[1]]}},list:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;return e instanceof Array?a.each(a.product(e.slice(0,-1),a.ignore(g)),e.slice(-1),a.ignore(d)):a.each(a.many(a.each(e,a.ignore(g))),px,a.ignore(d))},set:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;return function(h){var i=
null;for(var o=i=null,t=null,u=[[],h],s=false,l=0;l<e.length;l++){i=o=null;s=e.length==1;try{i=e[l].call(this,h)}catch(m){continue}t=[[i[0]],i[1]];if(i[1].length>0&&!s)try{o=g.call(this,i[1])}catch(n){s=true}else s=true;if(!s&&o[1].length===0)s=true;if(!s){i=[];for(s=0;s<e.length;s++)l!=s&&i.push(e[s]);i=a.set(i,g).call(this,o[1]);if(i[0].length>0){t[0]=t[0].concat(i[0]);t[1]=i[1]}}if(t[1].length<u[1].length)u=t;if(u[1].length===0)break}if(u[0].length===0)return u;if(d){try{o=d.call(this,u[1])}catch(k){throw new b.Exception(u[1]);
...
this.day,this.hour,this.minute,this.second);if(this.timezone)d.set({timezone:this.timezone});else this.timezoneOffset&&d.set({timezoneOffset:this.timezoneOffset});return d},finish:function(d){d=d instanceof Array?b(d):[d];if(d.length===0)return null;for(var h=0;h<d.length;h++)typeof d[h]=="function"&&d[h].call(this);if(this.now)return new Date;d=Date.today();if(this.days!=null||this.orient||this.operator){var i,o;o=this.orient=="past"||this.operator=="subtract"?-1:1;if(this.weekday){this.unit="day";
h=Date.getDayNumberFromName(this.weekday)-d.getDay();i=7;this.days=h?(h+o*i)%i:o*i}if(this.month){this.unit="month";h=this.month-d.getMonth();i=12;this.months=h?(h+o*i)%i:o*i;this.month=null}if(!this.unit)this.unit="day";if(this[this.unit+"s"]==null||this.operator!=null){if(!this.value)this.value=1;if(this.unit=="week"){this.unit="day";this.value*=7}this[this.unit+"s"]=this.value*o}return d.add(this)}else{if(this.meridian&&this.hour)this.hour=this.hour<13&&this.meridian=="p"?this.hour+12:this.hour;
if(this.weekday&&!this.day)this.day=d.addDays(Date.getDayNumberFromName(this.weekday)-d.getDay()).getDate();if(this.month&&!this.day)this.day=1;return d.set(this)}}};var a=Date.Parsing.Operators,c=Date.Grammar,f=Date.Translator,j;c.datePartDelimiter=a.rtoken(/^([\s\-\.\,\/\x27]+)/);c.timePartDelimiter=a.stoken(":");c.whiteSpace=a.rtoken(/^\s*/);c.generalDelimiter=a.rtoken(/^(([\s\,]|at|on)+)/);var e={};c.ctoken=function(d){var h=e[d];if(!h){h=Date.CultureInfo.regexPatterns;for(var i=d.split(/\s+/),
o=[],t=0;t<i.length;t++)o.push(a.replace(a.rtoken(h[i[t]]),i[t]));h=e[d]=a.any.apply(null,o)}return h};c.ctoken2=function(d){return a.rtoken(Date.CultureInfo.regexPatterns[d])};c.h=a.cache(a.process(a.rtoken(/^(0[0-9]|1[0-2]|[1-9])/),f.hour));c.hh=a.cache(a.process(a.rtoken(/^(0[0-9]|1[0-2])/),f.hour));c.H=a.cache(a.process(a.rtoken(/^([0-1][0-9]|2[0-3]|[0-9])/),f.hour));c.HH=a.cache(a.process(a.rtoken(/^([0-1][0-9]|2[0-3])/),f.hour));c.m=a.cache(a.process(a.rtoken(/^([0-5][0-9]|[0-9])/),f.minute));
...
d}}));c.M=a.cache(a.process(a.rtoken(/^(1[0-2]|0\d|\d)/),f.month));c.MM=a.cache(a.process(a.rtoken(/^(1[0-2]|0\d)/),f.month));c.MMM=c.MMMM=a.cache(a.process(c.ctoken("jan feb mar apr may jun jul aug sep oct nov dec"),f.month));c.y=a.cache(a.process(a.rtoken(/^(\d\d?)/),f.year));c.yy=a.cache(a.process(a.rtoken(/^(\d\d)/),f.year));c.yyy=a.cache(a.process(a.rtoken(/^(\d\d?\d?\d?)/),f.year));c.yyyy=a.cache(a.process(a.rtoken(/^(\d\d\d\d)/),f.year));j=function(){return a.each(a.any.apply(null,arguments),
a.not(c.ctoken2("timeContext")))};c.day=j(c.d,c.dd);c.month=j(c.M,c.MMM);c.year=j(c.yyyy,c.yy);c.orientation=a.process(c.ctoken("past future"),function(d){return function(){this.orient=d}});c.operator=a.process(c.ctoken("add subtract"),function(d){return function(){this.operator=d}});c.rday=a.process(c.ctoken("yesterday tomorrow today now"),f.rday);c.unit=a.process(c.ctoken("minute hour day week month year"),function(d){return function(){this.unit=d}});c.value=a.process(a.rtoken(/^\d\d?(st|nd|rd|th)?/),
function(d){return function(){this.value=d.replace(/\D/g,"")}});c.expression=a.set([c.rday,c.operator,c.value,c.unit,c.orientation,c.ddd,c.MMM]);j=function(){return a.set(arguments,c.datePartDelimiter)};c.mdy=j(c.ddd,c.month,c.day,c.year);c.ymd=j(c.ddd,c.year,c.month,c.day);c.dmy=j(c.ddd,c.day,c.month,c.year);c.date=function(d){return(c[Date.CultureInfo.dateElementOrder]||c.mdy).call(this,d)};c.format=a.process(a.many(a.any(a.process(a.rtoken(/^(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|zz?z?)/),
function(d){if(c[d])return c[d];else throw Date.Parsing.Exception(d);}),a.process(a.rtoken(/^[^dMyhHmstz]+/),function(d){return a.ignore(a.stoken(d))}))),function(d){return a.process(a.each.apply(null,d),f.finishExact)});var g={};c.formats=function(d){if(d instanceof Array){for(var h=[],i=0;i<d.length;i++)h.push(g[d[i]]=g[d[i]]||c.format(d[i])[0]);return a.any.apply(null,h)}else return g[d]=g[d]||c.format(d)[0]};c._formats=c.formats(["yyyy-MM-ddTHH:mm:ss","ddd, MMM dd, yyyy H:mm:ss tt","ddd MMM d yyyy HH:mm:ss zzz",
"d"]);c._start=a.process(a.set([c.date,c.time,c.expression],c.generalDelimiter,c.whiteSpace),f.finish);c.start=function(d){try{var h=c._formats.call({},d);if(h[1].length===0)return h}catch(i){}return c._start.call({},d)}})();Date._parse=Date.parse;Date.parse=function(b){var a=null;if(!b)return null;try{a=Date.Grammar.start.call({},b)}catch(c){return null}return a[1].length===0?a[0]:null};
Date.getParseFunction=function(b){var a=Date.Grammar.formats(b);return function(c){var f=null;try{f=a.call({},c)}catch(j){return null}return f[1].length===0?f[0]:null}};Date.parseExact=function(b,a){return Date.getParseFunction(a)(b)};var SimpleDB,__indexOf=Array.prototype.indexOf||function(b){for(var a=0,c=this.length;a<c;a++)if(this[a]===b)return a;return-1};
SimpleDB=function(){function b(a,c){this.profile=a;this.endpoint=c!=null?c:"sdb.amazonaws.com";this.sdb_base_url="http://"+this.endpoint+"?"}b.prototype.set_profile=function(a){return this.profile=a};b.prototype.default_callback=function(a){return console.log(a)};b.prototype.build_request_url=function(a,c){var f,j;c.Action=a;c.Timestamp=AwsUtils.date_time_format();c.AWSAccessKeyId=this.profile.get_settings().get_access_key();c.Version=this.profile.get_settings().get_version();c.SignatureVersion=1;
c.Signature=AwsUtils.generate_sig(c,this.profile.get_settings().get_secret_key());return this.sdb_base_url+function(){var e;e=[];for(f in c){j=c[f];e.push(f+"="+encodeURIComponent(j))}return e}().join("&")};b.parse_metadata=function(a,c,f){return{meta:{req_id:$("RequestId",a).text(),box_usage:parseFloat($("BoxUsage",a).text()),status:c,req_url:f}}};b.prototype.ajax_request=function(a,c,f,j){if(f==null)f="GET";if(j==null)j=c;return $.ajax({type:f,url:a,success:function(e,g){return c(b.parse_metadata(e,
g,a),e)},error:function(e,g){var d;d=b.parse_metadata(e.responseXML,g,a);d.error={msg:$("Message",e.responseXML).text(),code:$("Code",e.responseXML).text()};return j(d,e.responseXML)},dataType:"xml"})};b.prototype.list_domains=function(a,c,f){var j,e;if(a==null)a=this.default_callback;if(c==null)c=100;if(f==null)f=null;if(__indexOf.call(function(){e=[];for(j=1;j<=100;j++)e.push(j);return e}.apply(this),c)<0)throw"Max domains must be between 1 and 100";c={MaxNumberOfDomains:c};if(f)c.NextToken=f;return this.ajax_request(this.build_request_url("ListDomains",
c),function(g,d){var h;g.error!=null&&a(g);h=[];$("DomainName",d).each(function(){return h.push($(this).text())});g.domains=h;g.next_token=$("NextToken",d).text();return a(g)})};b.prototype.domain_metadata=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DomainMetadata",{DomainName:a}),function(f,j){f.error!=null&&c(f);f.creation_date_time=$("CreationDateTime",j).text();f.item_count=parseInt($("ItemCount",j).text());f.item_names_size_bytes=parseInt($("ItemNamesSizeBytes",
j).text());f.attribute_name_count=parseInt($("AttributeNameCount",j).text());f.attribute_names_size_bytes=parseInt($("AttributeNamesSizeBytes",j).text());f.attribute_value_count=parseInt($("AttributeValueCount",j).text());f.attribute_values_size_bytes=parseInt($("AttributeValuesSizeBytes",j).text());f.timestamp=$("Timestamp",j).text();return c(f)})};b.prototype.select=function(a,c,f){if(c==null)c=this.default_callback;if(f==null)f=null;a={SelectExpression:a};if(f)a.NextToken=f;return this.ajax_request(this.build_request_url("Select",
a),function(j,e){var g;j.error!=null&&c(j);g=[];$("Item",e).each(function(){var d;d={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var h,i;h=$("Name",$(this)).text();i=$("Value",$(this)).text();d.attrs[h]||(d.attrs[h]=[]);return d.attrs[h].push(i)});return g.push(d)});j.items=g;j.next_token=$("NextToken",e).text();return c(j)})};b.prototype.get_attributes=function(a,c,f,j){var e;if(f==null)f=this.default_callback;if(j==null)j=[];c={DomainName:a,ItemName:c};a=
0;for(e=j.length;0<=e?a<e:a>e;0<=e?a++:a--)c["AttributeName."+a]=j[a];return this.ajax_request(this.build_request_url("GetAttributes",c),function(g,d){var h;g.error!=null&&f(g);h={};$("Attribute",d).each(function(){var i,o;i=$("Name",$(this)).text();o=$("Value",$(this)).text();h[i]||(h[i]=[]);return h[i].push(o)});g.attributes=h;return f(g)})};b.prototype.put_attributes=function(a,c,f,j){var e,g,d,h,i,o,t;if(j==null)j=this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=f.length;h<o;h++){a=
f[h];e=a.values;i=0;for(t=e.length;i<t;i++){d=e[i];g["Attribute."+c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;if(a.replace&&a.replace===true)g["Attribute."+c+".Replace"]=true;c+=1}}return this.ajax_request(this.build_request_url("PutAttributes",g),function(u){return j(u)})};b.prototype.delete_attributes=function(a,c,f,j){var e,g,d,h,i,o,t;if(j==null)j=this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=f.length;h<o;h++){a=f[h];if(e=a.values){i=0;for(t=e.length;i<t;i++){d=e[i];g["Attribute."+
c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;c+=1}}else{g["Attribute."+c+".Name"]=a.name;c+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",g),function(u){return j(u)})};b.prototype.batch_delete_attributes=function(a,c,f){var j,e,g,d,h,i,o,t,u,s,l;if(f==null)f=this.default_callback;d={DomainName:a};a=0;for(s=c.length;0<=s?a<s:a>s;0<=s?a++:a--){j=c[a];e=j.item_name;d["Item."+a+".ItemName"]=e;e=0;l=j.item_attrs;i=0;for(t=l.length;i<t;i++){j=l[i];if(g=j.values){o=0;for(u=g.length;o<
u;o++){h=g[o];d["Item."+a+".Attribute."+e+".Name"]=j.name;d["Item."+a+".Attribute."+e+".Value"]=h;e+=1}}else{d["Item."+a+".Attribute."+e+".Name"]=j.name;e+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",d),function(m){return f(m)})};b.prototype.batch_put_attributes=function(a,c,f){var j,e,g,d,h,i,o,t,u,s,l;if(f==null)f=this.default_callback;d={DomainName:a};a=0;for(s=c.length;0<=s?a<s:a>s;0<=s?a++:a--){j=c[a];e=j.item_name;d["Item."+a+".ItemName"]=e;e=0;l=j.item_attrs;
i=0;for(t=l.length;i<t;i++){j=l[i];g=j.values;o=0;for(u=g.length;o<u;o++){h=g[o];d["Item."+a+".Attribute."+e+".Name"]=j.name;d["Item."+a+".Attribute."+e+".Value"]=h;if(j.replace&&j.replace===true)d["Item."+a+".Attribute."+e+".Replace"]=true;e+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",d),function(m){return f(m)})};b.prototype.create_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),
function(f){return c(f)})};b.prototype.delete_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",{DomainName:a}),function(f){return c(f)})};return b}();var Storage;
...
SHA1=function(){var b,a,c,f,j,e,g,d,h,i,o,t,u,s;f={};i=function(l){return b(a(g(l),l.length*8))};h=function(l,m){var n,k,q,p;n=g(l);if(n.length>16)n=a(n,l.length*8);q=Array(16);p=Array(16);for(k=0;k<16;k++){q[k]=n[k]^909522486;p[k]=n[k]^1549556828}n=a(q.concat(g(m)),512+m.length*8);return b(a(p.concat(n),672))};d=function(l,m){var n,k,q,p,v;if(m==null)m=true;n=m?"0123456789abcdef":"0123456789ABCDEF";q="";k=0;for(v=l.length;0<=v?k<v:k>v;0<=v?k++:k--){p=l.charCodeAt(k);q+=n.charAt(p>>>4&15)+n.charAt(p&
15)}return q};e=function(l,m){var n,k,q,p,v;if(m==null)m="=";p="";q=l.length;for(n=0;n<q;n+=3){v=l.charCodeAt(n)<<16|(n+1<q?l.charCodeAt(n+1)<<8:0)|(n+2<q?l.charCodeAt(n+2):0);for(k=0;k<4;k++)p+=n*8+k*6>l.length*8?m:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(v>>>6*(3-k)&63)}return p};j=function(l,m){var n,k,q,p,v,x,w,y;k=m.length;q=[];n=Array(Math.ceil(l.length/2));p=0;for(v=n.length;0<=v?p<v:p>v;0<=v?p++:p--)n[p]=l.charCodeAt(p*2)<<8|l.charCodeAt(p*2+1);for(;n.length>
...
B);p=o(p,C);v=o(v,D)}return Array(n,k,q,p,v)};t=function(l,m,n,k){return l<20?m&n|~m&k:l<40?m^n^k:l<60?m&n|m&k|n&k:m^n^k};u=function(l){return l<20?1518500249:l<40?1859775393:l<60?-1894007588:-899497514};o=function(l,m){var n;n=(l&65535)+(m&65535);return(l>>16)+(m>>16)+(n>>16)<<16|n&65535};c=function(l,m){return l<<m|l>>>32-m};f.hex_sha1=function(l){return d(i(s(l)))};f.b64_sha1=function(l){return e(i(s(l)))};f.any_sha1=function(l,m){return j(i(s(l)),m)};f.hex_hmac_sha1=function(l,m){return d(h(s(l),
s(m)))};f.b64_hmac_sha1=function(l,m){return e(h(s(l),s(m)))};f.any_hmac_sha1=function(l,m,n){return j(h(s(l),s(m)),n)};return f}();var AwsUtils;
AwsUtils=function(){var b,a,c,f,j;j=function(e){e=e.toString();if(e.length<2)e="0"+e;return e};f=function(e){return[e.getUTCFullYear(),j(e.getUTCMonth()+1),j(e.getUTCDate())].join("-")};b=function(e){return[j(e.getUTCHours()),j(e.getUTCMinutes()),j(e.getUTCSeconds())].join(":")};c=function(e,g){return e===g?0:e.toLowerCase()>g.toLowerCase()?1:-1};a={};a.date_time_format=function(e){if(e==null)e=new Date;return""+f(e)+"T"+b(e)+".000Z"};a.generate_sig=function(e,g){var d,h,i;h=function(){var o;o=[];
for(d in e)o.push(d);return o}();h.sort(c);i=function(){var o,t,u;u=[];o=0;for(t=h.length;o<t;o++){d=h[o];u.push(""+d+e[d])}return u}();return SHA1.b64_hmac_sha1(g,i.join(""))};return a}();var Settings;
Settings=function(){function b(a,c,f,j){this.access_key=a;this.secret_key=c;this.region=f!=null?f:"us-east-1";this.version=j!=null?j:"2009-04-15"}b.prototype.use_access_key=function(a){this.access_key=a;return this};b.prototype.use_secret_key=function(a){this.secret_key=a;return this};b.prototype.use_region=function(a){this.region=a;return this};b.prototype.use_version=function(a){this.version=a;return this};b.prototype.get_access_key=function(){return this.access_key};b.prototype.get_secret_key=
