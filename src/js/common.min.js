(function(){var SHA1;
SHA1=function(){var b,a,c,f,i,e,g,d,h,j,o,s,u,v;f={};j=function(k){return b(a(g(k),k.length*8))};h=function(k,n){var m,l,p,q,t;m=g(k);if(m.length>16)m=a(m,k.length*8);p=Array(16);q=Array(16);for(l=t=0;t<16;l=++t){p[l]=m[l]^909522486;q[l]=m[l]^1549556828}m=a(p.concat(g(n)),512+n.length*8);return b(a(q.concat(m),672))};d=function(k,n){var m,l,p,q,t;if(n==null)n=true;m=n?"0123456789abcdef":"0123456789ABCDEF";p="";l=q=0;for(t=k.length;0<=t?q<t:q>t;l=0<=t?++q:--q){l=k.charCodeAt(l);p+=m.charAt(l>>>4&15)+
m.charAt(l&15)}return p};e=function(k,n){var m,l,p,q,t,x,w;if(n==null)n="=";q="";p=k.length;for(m=x=0;x<p;m=x+=3){t=k.charCodeAt(m)<<16|(m+1<p?k.charCodeAt(m+1)<<8:0)|(m+2<p?k.charCodeAt(m+2):0);for(l=w=0;w<4;l=++w)q+=m*8+l*6>k.length*8?n:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(t>>>6*(3-l)&63)}return q};i=function(k,n){var m,l,p,q,t,x,w,y;l=n.length;p=[];m=Array(Math.ceil(k.length/2));q=t=0;for(x=m.length;0<=x?t<x:t>x;q=0<=x?++t:--t)m[q]=k.charCodeAt(q*2)<<8|k.charCodeAt(q*
2+1);for(;m.length>0;){t=[];q=w=x=0;for(y=m.length;0<=y?w<y:w>y;q=0<=y?++w:--w){x=(x<<16)+m[q];q=Math.floor(x/l);x-=q*l;if(t.length>0||q>0)t[t.length]=q}p[p.length]=x;m=t}m="";for(q=l=t=p.length-1;t<=0?l<=0:l>=0;q=t<=0?++l:--l)m+=n.charAt(p[q]);p=Math.ceil(k.length*8/(Math.log(n.length)/Math.log(2)));for(q=l=m.length;l<=p?q<=p:q>=p;l<=p?++q:--q)m=n[0]+m;return m};v=function(k){var n,m,l,p,q;m="";n=p=0;for(q=k.length;0<=q?p<q:p>q;n=0<=q?++p:--p){l=k.charCodeAt(n);n=n+1<k.length?k.charCodeAt(n+1):0;
if(55296<=l&&l<=56319&&56320<=n&&n<=57343)l=65536+((l&1023)<<10)+(n&1023);if(l<=127)m+=String.fromCharCode(l);else if(l<=2047)m+=String.fromCharCode(192|l>>>6&31,128|l&63);else if(l<=65535)m+=String.fromCharCode(224|l>>>12&15,128|l>>>6&63,128|l&63);else if(l<=2097151)m+=String.fromCharCode(240|l>>>18&7,128|l>>>12&63,128|l>>>6&63,128|l&63)}return m};g=function(k){var n,m,l,p;m=Array(k.length>>2);n=l=0;for(p=m.length;0<=p?l<p:l>p;n=0<=p?++l:--l)m[n]=0;n=l=0;for(p=k.length*8;l<p;n=l+=8)m[n>>5]|=(k.charCodeAt(n/
8)&255)<<24-n%32;return m};b=function(k){var n,m,l,p;m="";n=l=0;for(p=k.length*32;l<p;n=l+=8)m+=String.fromCharCode(k[n>>5]>>>24-n%32&255);return m};a=function(k,n){var m,l,p,q,t,x,w,y,C,D,E,F,z,A,B,G;k[n>>5]|=128<<24-n%32;k[(n+64>>9<<4)+15]=n;z=Array(80);m=1732584193;l=-271733879;p=-1732584194;q=271733878;t=-1009589776;x=A=0;for(G=k.length;A<G;x=A+=16){y=m;C=l;D=p;E=q;F=t;for(w=B=0;B<80;w=++B){z[w]=w<16?k[x+w]:c(z[w-3]^z[w-8]^z[w-14]^z[w-16],1);w=o(o(c(m,5),s(w,l,p,q)),o(o(t,z[w]),u(w)));t=q;q=p;
p=c(l,30);l=m;m=w}m=o(m,y);l=o(l,C);p=o(p,D);q=o(q,E);t=o(t,F)}return Array(m,l,p,q,t)};s=function(k,n,m,l){return k<20?n&m|~n&l:k<40?n^m^l:k<60?n&m|n&l|m&l:n^m^l};u=function(k){return k<20?1518500249:k<40?1859775393:k<60?-1894007588:-899497514};o=function(k,n){var m;m=(k&65535)+(n&65535);return(k>>16)+(n>>16)+(m>>16)<<16|m&65535};c=function(k,n){return k<<n|k>>>32-n};f.hex_sha1=function(k){return d(j(v(k)))};f.b64_sha1=function(k){return e(j(v(k)))};f.any_sha1=function(k,n){return i(j(v(k)),n)};
f.hex_hmac_sha1=function(k,n){return d(h(v(k),v(n)))};f.b64_hmac_sha1=function(k,n){return e(h(v(k),v(n)))};f.any_hmac_sha1=function(k,n,m){return i(h(v(k),v(n)),m)};return f}();var Storage;Storage=function(){var b;b={};b.get=function(a,c){var f;if(c==null)c=false;f=localStorage.getItem(a);if(c)f=JSON.parse(f);return f};b.set=function(a,c,f){if(f==null)f=false;if(f)c=JSON.stringify(c);localStorage.setItem(a,c);return c};b.del=function(a){return localStorage.removeItem(a)};return b}();var Profile;
...
{},true)};b["delete"]=function(a){var c,f,i,e,g;i=b.find_all();f=[];c=e=0;for(g=i.length;0<=g?e<g:e>g;c=0<=g?++e:--e)i[c].get_name()!==a&&f.push(i[c]);return Storage.set("chrome-sdb.profiles",b.profiles_json(f),true)};return b}();var Settings;
Settings=function(){function b(a,c,f,i,e){this.access_key=a;this.secret_key=c;this.region=f!=null?f:"sdb.amazonaws.com";this.version=i!=null?i:"2009-04-15";this.https_protocol=e!=null?e:false}b.prototype.use_access_key=function(a){this.access_key=a;return this};b.prototype.use_secret_key=function(a){this.secret_key=a;return this};b.prototype.use_region=function(a){this.region=a;return this};b.prototype.use_version=function(a){this.version=a;return this};b.prototype.use_https_protocol=function(a){this.https_protocol=
...
new b(a.access_key,a.secret_key,a.region,a.version,a.https_protocol):null};return b}();
...
[],h=null,j=0;j<e.length;j++)if(e[j]!=null){try{h=e[j].call(this,g)}catch(o){throw new b.Exception(g);}d.push(h[0]);g=h[1]}return[d,g]}},all:function(){var e=e;return e.each(e.optional(arguments))},sequence:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;if(e.length==1)return e[0];return function(h){for(var j=null,o=null,s=[],u=0;u<e.length;u++){try{j=e[u].call(this,h)}catch(v){break}s.push(j[0]);try{o=g.call(this,j[1])}catch(k){o=null;break}h=o[1]}if(!j)throw new b.Exception(h);if(o)throw new b.Exception(o[1]);
if(d)try{j=d.call(this,j[1])}catch(n){throw new b.Exception(j[1]);}return[s,j?j[1]:h]}},between:function(e,g,d){d=d||e;var h=a.each(a.ignore(e),g,a.ignore(d));return function(j){j=h.call(this,j);return[[j[0][0],r[0][2]],j[1]]}},list:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;return e instanceof Array?a.each(a.product(e.slice(0,-1),a.ignore(g)),e.slice(-1),a.ignore(d)):a.each(a.many(a.each(e,a.ignore(g))),px,a.ignore(d))},set:function(e,g,d){g=g||a.rtoken(/^\s*/);d=d||null;return function(h){var j=
null;for(var o=j=null,s=null,u=[[],h],v=false,k=0;k<e.length;k++){j=o=null;v=e.length==1;try{j=e[k].call(this,h)}catch(n){continue}s=[[j[0]],j[1]];if(j[1].length>0&&!v)try{o=g.call(this,j[1])}catch(m){v=true}else v=true;if(!v&&o[1].length===0)v=true;if(!v){j=[];for(v=0;v<e.length;v++)k!=v&&j.push(e[v]);j=a.set(j,g).call(this,o[1]);if(j[0].length>0){s[0]=s[0].concat(j[0]);s[1]=j[1]}}if(s[1].length<u[1].length)u=s;if(u[1].length===0)break}if(u[0].length===0)return u;if(d){try{o=d.call(this,u[1])}catch(l){throw new b.Exception(u[1]);
...
o=[],s=0;s<j.length;s++)o.push(a.replace(a.rtoken(h[j[s]]),j[s]));h=e[d]=a.any.apply(null,o)}return h};c.ctoken2=function(d){return a.rtoken(Date.CultureInfo.regexPatterns[d])};c.h=a.cache(a.process(a.rtoken(/^(0[0-9]|1[0-2]|[1-9])/),f.hour));c.hh=a.cache(a.process(a.rtoken(/^(0[0-9]|1[0-2])/),f.hour));c.H=a.cache(a.process(a.rtoken(/^([0-1][0-9]|2[0-3]|[0-9])/),f.hour));c.HH=a.cache(a.process(a.rtoken(/^([0-1][0-9]|2[0-3])/),f.hour));c.m=a.cache(a.process(a.rtoken(/^([0-5][0-9]|[0-9])/),f.minute));
...
Date.getParseFunction=function(b){var a=Date.Grammar.formats(b);return function(c){var f=null;try{f=a.call({},c)}catch(i){return null}return f[1].length===0?f[0]:null}};Date.parseExact=function(b,a){return Date.getParseFunction(a)(b)};var AwsUtils;
...
for(d in e)o.push(d);return o}();h.sort(c);j=function(){var o,s,u;u=[];o=0;for(s=h.length;o<s;o++){d=h[o];u.push(""+d+e[d])}return u}();return SHA1.b64_hmac_sha1(g,j.join(""))};return a}();var SimpleDB,__indexOf=[].indexOf||function(b){for(var a=0,c=this.length;a<c;a++)if(a in this&&this[a]===b)return a;return-1};
SimpleDB=function(){function b(a,c,f){this.profile=a;this.secure=c!=null?c:false;this.error_callback=f!=null?f:this.default_callback;this.protocol=this.secure?"https":"http";this.endpoint=this.profile.get_settings().get_region();this.sdb_base_url=""+this.protocol+"://"+this.endpoint+"?"}b.prototype.set_profile=function(a){return this.profile=a};b.prototype.default_callback=function(a,c){if(c==null)c=null;console.log(a);if(c!==null)return console.log(c)};b.prototype.build_request_url=function(a,c){var f,
i;c.Action=a;c.Timestamp=AwsUtils.date_time_format();c.AWSAccessKeyId=this.profile.get_settings().get_access_key();c.Version=this.profile.get_settings().get_version();c.SignatureVersion=1;c.Signature=AwsUtils.generate_sig(c,this.profile.get_settings().get_secret_key());return this.sdb_base_url+function(){var e;e=[];for(f in c){i=c[f];e.push(f+"="+encodeURIComponent(i))}return e}().join("&")};b.regions=function(){return[{name:"US East (Northern Virginia) Region",endpoint:"sdb.amazonaws.com"},{name:"US West (Oregon) Region",
endpoint:"sdb.us-west-2.amazonaws.com"},{name:"US West (Northern California) Region",endpoint:"sdb.us-west-1.amazonaws.com"},{name:"EU (Ireland) Region",endpoint:"sdb.eu-west-1.amazonaws.com"},{name:"Asia Pacific (Singapore) Region",endpoint:"sdb.ap-southeast-1.amazonaws.com"},{name:"Asia Pacific (Tokyo) Region",endpoint:"sdb.ap-northeast-1.amazonaws.com"},{name:"South America (Sao Paulo) Region",endpoint:"sdb.sa-east-1.amazonaws.com"}]};b.parse_metadata=function(a,c,f){return{meta:{req_id:$("RequestId",
a).text(),box_usage:parseFloat($("BoxUsage",a).text()),status:c,req_url:f}}};b.prototype.ajax_request=function(a,c,f,i){if(f==null)f="GET";if(i==null)i=this.error_callback;return $.ajax({type:f,url:a,success:function(e,g){return c(b.parse_metadata(e,g,a),e)},error:function(e,g){var d;d=b.parse_metadata(e.responseXML,g,a);d.error={msg:$("Message",e.responseXML).text(),code:$("Code",e.responseXML).text()};return i(d,e.responseXML)},dataType:"xml"})};b.prototype.list_domains=function(a,c,f){var i,e;
if(a==null)a=this.default_callback;if(c==null)c=100;if(f==null)f=null;if(__indexOf.call(function(){e=[];for(i=1;i<=100;i++)e.push(i);return e}.apply(this),c)<0)throw"Max domains must be between 1 and 100";c={MaxNumberOfDomains:c};if(f)c.NextToken=f;return this.ajax_request(this.build_request_url("ListDomains",c),function(g,d){var h;h=[];$("DomainName",d).each(function(){return h.push($(this).text())});g.domains=h;g.next_token=$("NextToken",d).text();return a(g)})};b.prototype.domain_metadata=function(a,
c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DomainMetadata",{DomainName:a}),function(f,i){f.creation_date_time=$("CreationDateTime",i).text();f.item_count=parseInt($("ItemCount",i).text());f.item_names_size_bytes=parseInt($("ItemNamesSizeBytes",i).text());f.attribute_name_count=parseInt($("AttributeNameCount",i).text());f.attribute_names_size_bytes=parseInt($("AttributeNamesSizeBytes",i).text());f.attribute_value_count=parseInt($("AttributeValueCount",i).text());
f.attribute_values_size_bytes=parseInt($("AttributeValuesSizeBytes",i).text());f.timestamp=$("Timestamp",i).text();return c(f)})};b.prototype.select=function(a,c,f){if(c==null)c=this.default_callback;if(f==null)f=null;a={SelectExpression:a};if(f)a.NextToken=f;return this.ajax_request(this.build_request_url("Select",a),function(i,e){var g,d,h;h=[];d={};$("Item",e).each(function(){var j;j={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var o,s;o=$("Name",$(this)).text();
d[o]=o;s=$("Value",$(this)).text();j.attrs[o]||(j.attrs[o]=[]);return j.attrs[o].push(s)});return h.push(j)});i.items=h;i.attr_names=function(){var j;j=[];for(g in d)j.push(g);return j}();f=$("NextToken",e).text();if(f!=="")i.next_token=f;return c(i)})};b.prototype.get_attributes=function(a,c,f,i){var e,g;if(f==null)f=this.default_callback;if(i==null)i=[];c={DomainName:a,ItemName:c};a=e=0;for(g=i.length;0<=g?e<g:e>g;a=0<=g?++e:--e)c["AttributeName."+a]=i[a];return this.ajax_request(this.build_request_url("GetAttributes",
c),function(d,h){var j;d.error!=null&&f(d);j={};$("Attribute",h).each(function(){var o,s;o=$("Name",$(this)).text();s=$("Value",$(this)).text();j[o]||(j[o]=[]);return j[o].push(s)});d.attributes=j;return f(d)})};b.prototype.put_attributes=function(a,c,f,i){var e,g,d,h,j,o,s;if(i==null)i=this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=f.length;h<o;h++){a=f[h];e=a.values;j=0;for(s=e.length;j<s;j++){d=e[j];g["Attribute."+c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;if(a.replace&&a.replace===
true)g["Attribute."+c+".Replace"]=true;c+=1}}return this.ajax_request(this.build_request_url("PutAttributes",g),function(u){return i(u)})};b.prototype.delete_attributes=function(a,c,f,i){var e,g,d,h,j,o,s;if(i==null)i=this.default_callback;g={DomainName:a,ItemName:c};h=c=0;for(o=f.length;h<o;h++){a=f[h];if(e=a.values){j=0;for(s=e.length;j<s;j++){d=e[j];g["Attribute."+c+".Name"]=a.name;g["Attribute."+c+".Value"]=d;c+=1}}else{g["Attribute."+c+".Name"]=a.name;c+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",
g),function(u){return i(u)})};b.prototype.batch_delete_attributes=function(a,c,f){var i,e,g,d,h,j,o,s,u,v,k,n;if(f==null)f=this.default_callback;d={DomainName:a};a=j=0;for(k=c.length;0<=k?j<k:j>k;a=0<=k?++j:--j){i=c[a];e=i.item_name;d["Item."+a+".ItemName"]=e;e=0;n=i.item_attrs;o=0;for(u=n.length;o<u;o++){i=n[o];if(g=i.values){s=0;for(v=g.length;s<v;s++){h=g[s];d["Item."+a+".Attribute."+e+".Name"]=i.name;d["Item."+a+".Attribute."+e+".Value"]=h;e+=1}}else{d["Item."+a+".Attribute."+e+".Name"]=i.name;
e+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",d),function(m){return f(m)})};b.prototype.batch_put_attributes=function(a,c,f){var i,e,g,d,h,j,o,s,u,v,k,n;if(f==null)f=this.default_callback;d={DomainName:a};a=j=0;for(k=c.length;0<=k?j<k:j>k;a=0<=k?++j:--j){i=c[a];e=i.item_name;d["Item."+a+".ItemName"]=e;e=0;n=i.item_attrs;o=0;for(u=n.length;o<u;o++){i=n[o];g=i.values;s=0;for(v=g.length;s<v;s++){h=g[s];d["Item."+a+".Attribute."+e+".Name"]=i.name;d["Item."+a+".Attribute."+
e+".Value"]=h;if(i.replace&&i.replace===true)d["Item."+a+".Attribute."+e+".Replace"]=true;e+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",d),function(m){return f(m)})};b.prototype.create_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),function(f){return c(f)})};b.prototype.delete_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",
{DomainName:a}),function(f){return c(f)})};return b}();})();
