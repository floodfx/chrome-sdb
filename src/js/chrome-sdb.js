...
SimpleDB = (function() {
  ...
  SimpleDB.prototype.parse_metadata = function(data, text_status, req_url) {
    return {
      meta: {
  ...
  SimpleDB.prototype.ajax_request = function(url, callback, type, error_callback) {
    ...
    req_success_callback = __bind(function(data, text_status) {
      return callback(this.parse_metadata(data, text_status, url), data);
    }, this);
    req_error_callback = __bind(function(xhr, text_status, error) {
      var result;
  ...
  SimpleDB.prototype.list_domains = function(callback, max_domains, next_token) {
    var action, params, result_handler, _i, _results;
    if (max_domains == null) {
      max_domains = 100;
    }
    if (next_token == null) {
    ...
    result_handler = function(result, data) {
      var domains;
    ...
    return this.ajax_request(this.build_request_url(action, params), result_handler);
  };
  SimpleDB.prototype.domainMetadata = function(domain_name, callback) {
    var action;
    action = "DomainMetadata";
    return this.ajax_request(this.build_request_url(action, {
...
AwsUtils = (function() {
  ...
  sort_lower_case = function(s1, s2) {
    ...
    if (s1 === s2) {
      ...
      return (_ref = s1.toLowerCase() > s2.toLowerCase()) != null ? _ref : {
        1: -1
      };
    }
  };
  ...
  return pub;
})();var access_key, profile, sdb, secret_key, settings;
access_key = '16NWKGHJ66RZQ9M14JR2';
secret_key = 'foPqFkOgHezvOuxkKMnHbrPLE0Im8GfJaJZbORJY';
settings = new Settings(access_key, secret_key);
profile = new Profile("test", settings);
sdb = new SimpleDB(profile);
sdb.list_domains(function(domains) {
