...
Storage=function(){var a;a={};a.get=function(b,c){var d;if(c==null)c=false;d=localStorage.getItem(b);if(c)d=JSON.parse(d);return d};a.set=function(b,c,d){if(d==null)d=false;if(d)c=JSON.stringify(c);localStorage.setItem(b,c);return c};a.del=function(b){return localStorage.removeItem(b)};return a}();var Settings;
...
new a(b.access_key,b.secret_key,b.region,b.version,b.https_protocol):null};return a}();var Profile;
