...
Settings=function(){function a(b,c,d,e){this.access_key=b;this.secret_key=c;this.region=d!=null?d:"us-east-1";this.version=e!=null?e:"2009-04-15"}a.prototype.use_access_key=function(b){this.access_key=b;return this};a.prototype.use_secret_key=function(b){this.secret_key=b;return this};a.prototype.use_region=function(b){this.region=b;return this};a.prototype.use_version=function(b){this.version=b;return this};a.prototype.get_access_key=function(){return this.access_key};a.prototype.get_secret_key=function(){return this.secret_key};
a.prototype.get_region=function(){return this.region};a.prototype.get_version=function(){return this.version};a.prototype.to_json=function(){return{access_key:this.access_key,secret_key:this.secret_key,region:this.region,version:this.version}};a.from_json=function(b){return b?new a(b.access_key,b.secret_key,b.region,b.version):null};return a}();var Storage;
...
i.push("<tr><td>"+d+"</td><td>"+a+"</td><td>"+c+"</td><td>"+j+"</td><td>"+b+"</td></tr>")}return i}();return $("#profiles_table > tbody").html(g.join(""))};save_profile=function(){var a,b,c;b=$("#profile_name").val();a=$("#profile_aws_access_key").val();c=$("#profile_aws_secret_key").val();(new Profile(b,new Settings(a,c))).save();$("#create_profile_modal").modal("hide");return update_profiles_table()};cancel_profile=function(){console.log("cancel");return $("#create_profile_modal").modal("hide")};
