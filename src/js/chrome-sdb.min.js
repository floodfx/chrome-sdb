...
$("#metadata_btn_ok").click(function(){return $("#domain_metadata_modal").modal("hide")});return $(".msg_box_close").click(function(){return $("#message_box").hide()})});
