...
id:"eight",next:"ninth",position:6,title:"Edit attributes",width:450,offset:{top:-30,left:0}});return guiders.createGuider({buttons:[{name:"Close",onclick:finish_tour}],description:"That's it!  Please submit feedback and bugs and enjoy.",id:"ninth",overlay:true,title:"Cool? Cool..."})}});var AwsUtils;
AwsUtils=function(){var b,a,c,d,f;f=function(e){e=e.toString();if(e.length<2)e="0"+e;return e};d=function(e){return[e.getUTCFullYear(),f(e.getUTCMonth()+1),f(e.getUTCDate())].join("-")};b=function(e){return[f(e.getUTCHours()),f(e.getUTCMinutes()),f(e.getUTCSeconds())].join(":")};c=function(e,k){return e===k?0:e.toLowerCase()>k.toLowerCase()?1:-1};a={};a.date_time_format=function(e){if(e==null)e=new Date;return""+d(e)+"T"+b(e)+".000Z"};a.generate_sig=function(e,k){var p,q,o;q=function(){var l;l=[];
for(p in e)l.push(p);return l}();q.sort(c);o=function(){var l,s,u;u=[];l=0;for(s=q.length;l<s;l++){p=q[l];u.push(""+p+e[p])}return u}();return SHA1.b64_hmac_sha1(k,o.join(""))};return a}();var SimpleDB,__indexOf=[].indexOf||function(b){for(var a=0,c=this.length;a<c;a++)if(a in this&&this[a]===b)return a;return-1};
...
a).text(),box_usage:parseFloat($("BoxUsage",a).text()),status:c,req_url:d}}};b.prototype.ajax_request=function(a,c,d,f){if(d==null)d="GET";if(f==null)f=this.error_callback;return $.ajax({type:d,url:a,success:function(e,k){return c(b.parse_metadata(e,k,a),e)},error:function(e,k){var p;p=b.parse_metadata(e.responseXML,k,a);p.error={msg:$("Message",e.responseXML).text(),code:$("Code",e.responseXML).text()};return f(p,e.responseXML)},dataType:"xml"})};b.prototype.list_domains=function(a,c,d){var f,e;
if(a==null)a=this.default_callback;if(c==null)c=100;if(d==null)d=null;if(__indexOf.call(function(){e=[];for(f=1;f<=100;f++)e.push(f);return e}.apply(this),c)<0)throw"Max domains must be between 1 and 100";c={MaxNumberOfDomains:c};if(d)c.NextToken=d;return this.ajax_request(this.build_request_url("ListDomains",c),function(k,p){var q;q=[];$("DomainName",p).each(function(){return q.push($(this).text())});k.domains=q;k.next_token=$("NextToken",p).text();return a(k)})};b.prototype.domain_metadata=function(a,
...
d.attribute_values_size_bytes=parseInt($("AttributeValuesSizeBytes",f).text());d.timestamp=$("Timestamp",f).text();return c(d)})};b.prototype.select=function(a,c,d){if(c==null)c=this.default_callback;if(d==null)d=null;a={SelectExpression:a};if(d)a.NextToken=d;return this.ajax_request(this.build_request_url("Select",a),function(f,e){var k,p,q;q=[];p={};$("Item",e).each(function(){var o;o={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var l,s;l=$("Name",$(this)).text();
p[l]=l;s=$("Value",$(this)).text();o.attrs[l]||(o.attrs[l]=[]);return o.attrs[l].push(s)});return q.push(o)});f.items=q;f.attr_names=function(){var o;o=[];for(k in p)o.push(k);return o}();d=$("NextToken",e).text();if(d!=="")f.next_token=d;return c(f)})};b.prototype.get_attributes=function(a,c,d,f){var e,k;if(d==null)d=this.default_callback;if(f==null)f=[];c={DomainName:a,ItemName:c};a=e=0;for(k=f.length;0<=k?e<k:e>k;a=0<=k?++e:--e)c["AttributeName."+a]=f[a];return this.ajax_request(this.build_request_url("GetAttributes",
c),function(p,q){var o;p.error!=null&&d(p);o={};$("Attribute",q).each(function(){var l,s;l=$("Name",$(this)).text();s=$("Value",$(this)).text();o[l]||(o[l]=[]);return o[l].push(s)});p.attributes=o;return d(p)})};b.prototype.put_attributes=function(a,c,d,f){var e,k,p,q,o,l,s;if(f==null)f=this.default_callback;k={DomainName:a,ItemName:c};q=c=0;for(l=d.length;q<l;q++){a=d[q];e=a.values;o=0;for(s=e.length;o<s;o++){p=e[o];k["Attribute."+c+".Name"]=a.name;k["Attribute."+c+".Value"]=p;if(a.replace&&a.replace===
true)k["Attribute."+c+".Replace"]=true;c+=1}}return this.ajax_request(this.build_request_url("PutAttributes",k),function(u){return f(u)})};b.prototype.delete_attributes=function(a,c,d,f){var e,k,p,q,o,l,s;if(f==null)f=this.default_callback;k={DomainName:a,ItemName:c};q=c=0;for(l=d.length;q<l;q++){a=d[q];if(e=a.values){o=0;for(s=e.length;o<s;o++){p=e[o];k["Attribute."+c+".Name"]=a.name;k["Attribute."+c+".Value"]=p;c+=1}}else{k["Attribute."+c+".Name"]=a.name;c+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",
k),function(u){return f(u)})};b.prototype.batch_delete_attributes=function(a,c,d){var f,e,k,p,q,o,l,s,u,t,i,j;if(d==null)d=this.default_callback;p={DomainName:a};a=o=0;for(i=c.length;0<=i?o<i:o>i;a=0<=i?++o:--o){f=c[a];e=f.item_name;p["Item."+a+".ItemName"]=e;e=0;j=f.item_attrs;l=0;for(u=j.length;l<u;l++){f=j[l];if(k=f.values){s=0;for(t=k.length;s<t;s++){q=k[s];p["Item."+a+".Attribute."+e+".Name"]=f.name;p["Item."+a+".Attribute."+e+".Value"]=q;e+=1}}else{p["Item."+a+".Attribute."+e+".Name"]=f.name;
e+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",p),function(h){return d(h)})};b.prototype.batch_put_attributes=function(a,c,d){var f,e,k,p,q,o,l,s,u,t,i,j;if(d==null)d=this.default_callback;p={DomainName:a};a=o=0;for(i=c.length;0<=i?o<i:o>i;a=0<=i?++o:--o){f=c[a];e=f.item_name;p["Item."+a+".ItemName"]=e;e=0;j=f.item_attrs;l=0;for(u=j.length;l<u;l++){f=j[l];k=f.values;s=0;for(t=k.length;s<t;s++){q=k[s];p["Item."+a+".Attribute."+e+".Name"]=f.name;p["Item."+a+".Attribute."+
e+".Value"]=q;if(f.replace&&f.replace===true)p["Item."+a+".Attribute."+e+".Replace"]=true;e+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",p),function(h){return d(h)})};b.prototype.create_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),function(d){return c(d)})};b.prototype.delete_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",
{DomainName:a}),function(d){return c(d)})};return b}();var Storage;Storage=function(){var b;b={};b.get=function(a,c){var d;if(c==null)c=false;d=localStorage.getItem(a);if(c)d=JSON.parse(d);return d};b.set=function(a,c,d){if(d==null)d=false;if(d)c=JSON.stringify(c);localStorage.setItem(a,c);return c};b.del=function(a){return localStorage.removeItem(a)};return b}();var Profile;
...
{},true)};b["delete"]=function(a){var c,d,f,e,k;f=b.find_all();d=[];c=e=0;for(k=f.length;0<=k?e<k:e>k;c=0<=k?++e:--e)f[c].get_name()!==a&&d.push(f[c]);return Storage.set("chrome-sdb.profiles",b.profiles_json(d),true)};return b}();var SHA1;
SHA1=function(){var b,a,c,d,f,e,k,p,q,o,l,s,u,t;d={};o=function(i){return b(a(k(i),i.length*8))};q=function(i,j){var h,g,m,n,r;h=k(i);if(h.length>16)h=a(h,i.length*8);m=Array(16);n=Array(16);for(g=r=0;r<16;g=++r){m[g]=h[g]^909522486;n[g]=h[g]^1549556828}h=a(m.concat(k(j)),512+j.length*8);return b(a(n.concat(h),672))};p=function(i,j){var h,g,m,n,r;if(j==null)j=true;h=j?"0123456789abcdef":"0123456789ABCDEF";m="";g=n=0;for(r=i.length;0<=r?n<r:n>r;g=0<=r?++n:--n){g=i.charCodeAt(g);m+=h.charAt(g>>>4&15)+
h.charAt(g&15)}return m};e=function(i,j){var h,g,m,n,r,w,v;if(j==null)j="=";n="";m=i.length;for(h=w=0;w<m;h=w+=3){r=i.charCodeAt(h)<<16|(h+1<m?i.charCodeAt(h+1)<<8:0)|(h+2<m?i.charCodeAt(h+2):0);for(g=v=0;v<4;g=++v)n+=h*8+g*6>i.length*8?j:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r>>>6*(3-g)&63)}return n};f=function(i,j){var h,g,m,n,r,w,v,x;g=j.length;m=[];h=Array(Math.ceil(i.length/2));n=r=0;for(w=h.length;0<=w?r<w:r>w;n=0<=w?++r:--r)h[n]=i.charCodeAt(n*2)<<8|i.charCodeAt(n*
2+1);for(;h.length>0;){r=[];n=v=w=0;for(x=h.length;0<=x?v<x:v>x;n=0<=x?++v:--v){w=(w<<16)+h[n];n=Math.floor(w/g);w-=n*g;if(r.length>0||n>0)r[r.length]=n}m[m.length]=w;h=r}h="";for(n=g=r=m.length-1;r<=0?g<=0:g>=0;n=r<=0?++g:--g)h+=j.charAt(m[n]);m=Math.ceil(i.length*8/(Math.log(j.length)/Math.log(2)));for(n=g=h.length;g<=m?n<=m:n>=m;g<=m?++n:--n)h=j[0]+h;return h};t=function(i){var j,h,g,m,n;h="";j=m=0;for(n=i.length;0<=n?m<n:m>n;j=0<=n?++m:--m){g=i.charCodeAt(j);j=j+1<i.length?i.charCodeAt(j+1):0;
if(55296<=g&&g<=56319&&56320<=j&&j<=57343)g=65536+((g&1023)<<10)+(j&1023);if(g<=127)h+=String.fromCharCode(g);else if(g<=2047)h+=String.fromCharCode(192|g>>>6&31,128|g&63);else if(g<=65535)h+=String.fromCharCode(224|g>>>12&15,128|g>>>6&63,128|g&63);else if(g<=2097151)h+=String.fromCharCode(240|g>>>18&7,128|g>>>12&63,128|g>>>6&63,128|g&63)}return h};k=function(i){var j,h,g,m;h=Array(i.length>>2);j=g=0;for(m=h.length;0<=m?g<m:g>m;j=0<=m?++g:--g)h[j]=0;j=g=0;for(m=i.length*8;g<m;j=g+=8)h[j>>5]|=(i.charCodeAt(j/
8)&255)<<24-j%32;return h};b=function(i){var j,h,g,m;h="";j=g=0;for(m=i.length*32;g<m;j=g+=8)h+=String.fromCharCode(i[j>>5]>>>24-j%32&255);return h};a=function(i,j){var h,g,m,n,r,w,v,x,B,C,D,E,y,z,A,F;i[j>>5]|=128<<24-j%32;i[(j+64>>9<<4)+15]=j;y=Array(80);h=1732584193;g=-271733879;m=-1732584194;n=271733878;r=-1009589776;w=z=0;for(F=i.length;z<F;w=z+=16){x=h;B=g;C=m;D=n;E=r;for(v=A=0;A<80;v=++A){y[v]=v<16?i[w+v]:c(y[v-3]^y[v-8]^y[v-14]^y[v-16],1);v=l(l(c(h,5),s(v,g,m,n)),l(l(r,y[v]),u(v)));r=n;n=m;
m=c(g,30);g=h;h=v}h=l(h,x);g=l(g,B);m=l(m,C);n=l(n,D);r=l(r,E)}return Array(h,g,m,n,r)};s=function(i,j,h,g){return i<20?j&h|~j&g:i<40?j^h^g:i<60?j&h|j&g|h&g:j^h^g};u=function(i){return i<20?1518500249:i<40?1859775393:i<60?-1894007588:-899497514};l=function(i,j){var h;h=(i&65535)+(j&65535);return(i>>16)+(j>>16)+(h>>16)<<16|h&65535};c=function(i,j){return i<<j|i>>>32-j};d.hex_sha1=function(i){return p(o(t(i)))};d.b64_sha1=function(i){return e(o(t(i)))};d.any_sha1=function(i,j){return f(o(t(i)),j)};
d.hex_hmac_sha1=function(i,j){return p(q(t(i),t(j)))};d.b64_hmac_sha1=function(i,j){return e(q(t(i),t(j)))};d.any_hmac_sha1=function(i,j,h){return f(q(t(i),t(j)),h)};return d}();var Settings;
...
new b(a.access_key,a.secret_key,a.region,a.version,a.https_protocol):null};return b}();var add_domains,add_item,confirm_delete,confirm_delete_item,delete_domain,delete_item,disable_delete,domain_from_query,edit_item,enable_delete,handle_delete_toggle,handle_error,handle_query,metadata,profile,query,save_domain,save_item,sdb,update_domains_table,update_region;profile=Profile.primary();
handle_error=function(b){var a,c;a=b.error.code;c=b.error.msg;b=b.meta.req_url;$("#error_code").text(a);$("#error_msg").text(c);$("#error_url").attr("href",b);$("#message_box").show();return $("#query_btn").button("reset")};if(profile){sdb=new SimpleDB(profile,false,handle_error);$(function(){return update_domains_table()})}else window.location="config.html";update_region=function(b){profile.get_settings().use_region(b);profile.save();sdb=new SimpleDB(profile,false,handle_error);return update_domains_table()};
...
add_domains=function(b){var a,c,d,f,e;if(b.length===0){d="<tr><td>No domains in this region</td></tr>";return $("#domains_table > tbody").html(d)}else{$("#domains_table > tbody").html("");f=0;for(e=b.length;f<e;f++){d=b[f];c=$('<button id="metadata_'+d+'" data-domain="'+d+'" class="btn info">metadata</a>');c.click(function(){return metadata($(this).attr("data-domain"))});a=$('<button id="delete_'+d+'" data-domain="'+d+'" class="btn" disabled="disabled" style="margin-left:5px">delete</button>');a.click(function(){return confirm_delete($(this).attr("data-domain"))});
d=$('<a href="#">'+d+"</a>").click(function(){var k;k=$(this).html();return $("#query_expr").val("select * from `"+k+"`")});d=$("<td></td>").append(d).append("<br />").append(c).append(a);d=$("<tr></tr>").append(d);$("#domains_table > tbody").append(d)}$("#domain_select > option").remove();a=[];f=0;for(e=b.length;f<e;f++){d=b[f];a.push($("#domain_select").append($("<option>",{value:d}).text(d)))}return a}};
...
handle_query=function(b){var a,c,d,f,e,k,p,q,o;$("#message_box").hide();e=b.items.length;k=b.next_token;if(k!=null){k=k.replace(/\n/g,"");$("#next_page_btn").removeAttr("disabled").click(function(){return query(k)})}else $("#next_page_btn").attr("disabled","disabled").unbind("click");if(e===0){$("#query_results_table > thead").html("<tr><th>Items</th></tr>");$("#query_results_table > tbody").html("<tr><td>No results...</td></tr>")}else{e=function(){var l,s,u,t;u=b.attr_names;t=[];l=0;for(s=u.length;l<
s;l++){a=u[l];t.push("<th>"+a+"</th>")}return t}();$("#query_results_table > thead").html("<tr><th></th><th>Item Name</th>"+e.join("")+"</tr>");$("#query_results_table > tbody").html("");o=b.items;e=0;for(q=o.length;e<q;e++){f=o[e];p=function(){var l,s,u,t;u=b.attr_names;t=[];l=0;for(s=u.length;l<s;l++){a=u[l];c=f.attrs[a];if(c!=null)c.length>1?t.push('<td data-attr-name="'+a+'" data-attr-multivalued="true"><table class="multivalued"><tbody><tr><td>'+c.join("</td></tr><tr><td>")+"</td></tr></tbody></table></td>"):
t.push('<td data-attr-name="'+a+'" data-attr-multivalued="false">'+c.join("")+"</td>");else t.push('<td data-attr-name="'+a+'" data-attr-multivalued="false"></td>')}return t}();d=$('<td class="delete">x</td>').click(function(){return confirm_delete_item($(this).closest("tr").attr("data-item-name"))});d=$("<tr></tr>").attr("data-item-name",f.name).append(d).append("<td>"+f.name+"</td>").append(p.join(""));$("#query_results_table > tbody").append(d)}$("#query_results_table > tbody > tr").each(function(l,
s){return $(s).children("td").each(function(u,t){var i,j;if(u>1){i=function(){return $(this).addClass("edititem").dblclick(function(){var h,g,m;g=$(this).parent().attr("data-item-name");a=$(this).attr("data-attr-name");h=$(this).attr("data-attr-multivalued")==="true";m=[];h?$(this).children("table").children("tbody").children("tr").children("td").each(function(n,r){return m.push($(r).text())}):m.push($(this).text());return edit_item(domain_from_query(),g,a,m)})};j=function(){return $(this).removeClass("edititem")};
return $(t).hover(i,j)}})})}return $("#query_btn").button("reset")};query=function(b){var a;if(b==null)b=null;a=$("#query_expr").val();sdb.select(a,handle_query,b);return $("#query_btn").button("loading")};
