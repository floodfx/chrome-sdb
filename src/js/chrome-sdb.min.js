(function(){var SHA1;
SHA1=function(){var f,a,b,d,e,c,k,m,p,o,l,t,v,r;d={};o=function(h){return f(a(k(h),h.length*8))};p=function(h,i){var j,g,q,n;j=k(h);if(j.length>16)j=a(j,h.length*8);q=Array(16);n=Array(16);for(g=0;g<16;g++){q[g]=j[g]^909522486;n[g]=j[g]^1549556828}j=a(q.concat(k(i)),512+i.length*8);return f(a(n.concat(j),672))};m=function(h,i){var j,g,q,n,s;if(i==null)i=true;j=i?"0123456789abcdef":"0123456789ABCDEF";q="";g=0;for(s=h.length;0<=s?g<s:g>s;0<=s?g++:g--){n=h.charCodeAt(g);q+=j.charAt(n>>>4&15)+j.charAt(n&
...
f=function(h){var i,j,g;j="";i=0;for(g=h.length*32;i<g;i+=8)j+=String.fromCharCode(h[i>>5]>>>24-i%32&255);return j};a=function(h,i){var j,g,q,n,s,w,u,x,z,A,B,C,D,y,E;h[i>>5]|=128<<24-i%32;h[(i+64>>9<<4)+15]=i;y=Array(80);j=1732584193;g=-271733879;q=-1732584194;n=271733878;s=-1009589776;w=0;for(E=h.length;w<E;w+=16){x=j;z=g;A=q;B=n;C=s;for(u=0;u<80;u++){y[u]=u<16?h[w+u]:b(y[u-3]^y[u-8]^y[u-14]^y[u-16],1);D=l(l(b(j,5),t(u,g,q,n)),l(l(s,y[u]),v(u)));s=n;n=q;q=b(g,30);g=j;j=D}j=l(j,x);g=l(g,z);q=l(q,
A);n=l(n,B);s=l(s,C)}return Array(j,g,q,n,s)};t=function(h,i,j,g){return h<20?i&j|~i&g:h<40?i^j^g:h<60?i&j|i&g|j&g:i^j^g};v=function(h){return h<20?1518500249:h<40?1859775393:h<60?-1894007588:-899497514};l=function(h,i){var j;j=(h&65535)+(i&65535);return(h>>16)+(i>>16)+(j>>16)<<16|j&65535};b=function(h,i){return h<<i|h>>>32-i};d.hex_sha1=function(h){return m(o(r(h)))};d.b64_sha1=function(h){return c(o(r(h)))};d.any_sha1=function(h,i){return e(o(r(h)),i)};d.hex_hmac_sha1=function(h,i){return m(p(r(h),
...
k,a),c)},error:function(c,k){var m;m=f.parse_metadata(c.responseXML,k,a);m.error={msg:$("Message",c.responseXML).text(),code:$("Code",c.responseXML).text()};return e(m,c.responseXML)},dataType:"xml"})};f.prototype.list_domains=function(a,b,d){var e,c;if(a==null)a=this.default_callback;if(b==null)b=100;if(d==null)d=null;if(__indexOf.call(function(){c=[];for(e=1;e<=100;e++)c.push(e);return c}.apply(this),b)<0)throw"Max domains must be between 1 and 100";b={MaxNumberOfDomains:b};if(d)b.NextToken=d;return this.ajax_request(this.build_request_url("ListDomains",
b),function(k,m){var p;k.error!=null&&a(k);p=[];$("DomainName",m).each(function(){return p.push($(this).text())});k.domains=p;k.next_token=$("NextToken",m).text();return a(k)})};f.prototype.domain_metadata=function(a,b){if(b==null)b=this.default_callback;return this.ajax_request(this.build_request_url("DomainMetadata",{DomainName:a}),function(d,e){d.error!=null&&b(d);d.creation_date_time=$("CreationDateTime",e).text();d.item_count=parseInt($("ItemCount",e).text());d.item_names_size_bytes=parseInt($("ItemNamesSizeBytes",
...
a),function(e,c){var k,m,p;e.error!=null&&b(e);p=[];m={};$("Item",c).each(function(){var o;o={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var l,t;l=$("Name",$(this)).text();m[l]=l;t=$("Value",$(this)).text();o.attrs[l]||(o.attrs[l]=[]);return o.attrs[l].push(t)});return p.push(o)});e.items=p;e.attr_names=function(){var o;o=[];for(k in m)o.push(k);return o}();d=$("NextToken",c).text();if(d!=="")e.next_token=d;return b(e)})};f.prototype.get_attributes=function(a,
b,d,e){var c;if(d==null)d=this.default_callback;if(e==null)e=[];b={DomainName:a,ItemName:b};a=0;for(c=e.length;0<=c?a<c:a>c;0<=c?a++:a--)b["AttributeName."+a]=e[a];return this.ajax_request(this.build_request_url("GetAttributes",b),function(k,m){var p;k.error!=null&&d(k);p={};$("Attribute",m).each(function(){var o,l;o=$("Name",$(this)).text();l=$("Value",$(this)).text();p[o]||(p[o]=[]);return p[o].push(l)});k.attributes=p;return d(k)})};f.prototype.put_attributes=function(a,b,d,e){var c,k,m,p,o,l,
t;if(e==null)e=this.default_callback;k={DomainName:a,ItemName:b};p=b=0;for(l=d.length;p<l;p++){a=d[p];c=a.values;o=0;for(t=c.length;o<t;o++){m=c[o];k["Attribute."+b+".Name"]=a.name;k["Attribute."+b+".Value"]=m;if(a.replace&&a.replace===true)k["Attribute."+b+".Replace"]=true;b+=1}}return this.ajax_request(this.build_request_url("PutAttributes",k),function(v){return e(v)})};f.prototype.delete_attributes=function(a,b,d,e){var c,k,m,p,o,l,t;if(e==null)e=this.default_callback;k={DomainName:a,ItemName:b};
p=b=0;for(l=d.length;p<l;p++){a=d[p];if(c=a.values){o=0;for(t=c.length;o<t;o++){m=c[o];k["Attribute."+b+".Name"]=a.name;k["Attribute."+b+".Value"]=m;b+=1}}else{k["Attribute."+b+".Name"]=a.name;b+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",k),function(v){return e(v)})};f.prototype.batch_delete_attributes=function(a,b,d){var e,c,k,m,p,o,l,t,v,r,h;if(d==null)d=this.default_callback;m={DomainName:a};a=0;for(r=b.length;0<=r?a<r:a>r;0<=r?a++:a--){e=b[a];c=e.item_name;m["Item."+
a+".ItemName"]=c;c=0;h=e.item_attrs;o=0;for(t=h.length;o<t;o++){e=h[o];if(k=e.values){l=0;for(v=k.length;l<v;l++){p=k[l];m["Item."+a+".Attribute."+c+".Name"]=e.name;m["Item."+a+".Attribute."+c+".Value"]=p;c+=1}}else{m["Item."+a+".Attribute."+c+".Name"]=e.name;c+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",m),function(i){return d(i)})};f.prototype.batch_put_attributes=function(a,b,d){var e,c,k,m,p,o,l,t,v,r,h;if(d==null)d=this.default_callback;m={DomainName:a};a=0;for(r=
b.length;0<=r?a<r:a>r;0<=r?a++:a--){e=b[a];c=e.item_name;m["Item."+a+".ItemName"]=c;c=0;h=e.item_attrs;o=0;for(t=h.length;o<t;o++){e=h[o];k=e.values;l=0;for(v=k.length;l<v;l++){p=k[l];m["Item."+a+".Attribute."+c+".Name"]=e.name;m["Item."+a+".Attribute."+c+".Value"]=p;if(e.replace&&e.replace===true)m["Item."+a+".Attribute."+c+".Replace"]=true;c+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",m),function(i){return d(i)})};f.prototype.create_domain=function(a,b){if(b==null)b=
this.default_callback;return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),function(d){return b(d)})};f.prototype.delete_domain=function(a,b){if(b==null)b=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",{DomainName:a}),function(d){return b(d)})};return f}();var Profile;
...
{},true)};f["delete"]=function(a){var b,d,e,c;e=f.find_all();d=[];b=0;for(c=e.length;0<=c?b<c:b>c;0<=c?b++:b--)e[b].get_name()!==a&&d.push(e[b]);return Storage.set("chrome-sdb.profiles",f.profiles_json(d),true)};return f}();var cancel_domain,handle_delete_toggle,handle_query,metadata,profile,query,save_domain,sdb,update_domains_table;if(profile=Profile.primary()){sdb=new SimpleDB(profile);$(function(){return update_domains_table()})}else chrome.tabs.create({url:"config.html"});
update_domains_table=function(){return sdb.list_domains(function(f){var a,b,d;d=f.domains;f=function(){var e,c,k;k=[];e=0;for(c=d.length;e<c;e++){b=d[e];a='<button id="metadata_'+b+'" class="btn info" onclick="metadata(\''+b+"')\">metadata</a>";a+=' <button id="delete_'+b+'" class="btn secondary" onclick="confirm_delete(\''+b+'\')" disabled="disabled" style="margin-left:5px">delete</button>';k.push("<tr><td>"+b+"<br />"+a+"</td></tr>")}return k}();return $("#domains_table > tbody").html(f.join(""))})};
handle_delete_toggle=function(){var f;$("#domain_deletion_control").attr("disabled","disabled");f=$("button[id^=delete_]");if($("#domain_deletion_control").hasClass("active")){f.attr("disabled","disabled").addClass("secondary").removeClass("danger");$("#domain_deletion_control").text("Enable Delete").addClass("secondary").removeClass("danger")}else{f.removeAttr("disabled").addClass("danger").removeClass("secondary");$("#domain_deletion_control").text("Disable Delete").addClass("danger").removeClass("secondary")}return $("#domain_deletion_control").removeAttr("disabled")};
handle_query=function(f){var a,b,d,e,c,k;console.log(f);e=f.items.length;c=f.next_token;if(c!=null){c=c.replace(/\n/g,"");$("#next_page_btn").removeAttr("disabled").attr("onclick","query('"+c+"')")}else $("#next_page_btn").attr("disabled","disabled").removeAttr("onclick");if(e===0){$("#query_results_table > thead").html("<tr><th>Items</th></tr>");return $("#query_results_table > tbody").html("<tr><td>No results...</td></tr>")}else{e=function(){var m,p,o,l;o=f.attr_names;l=[];m=0;for(p=o.length;m<
p;m++){a=o[m];l.push("<th>"+a+"</th>")}return l}();c=function(){var m,p,o,l;o=f.items;l=[];m=0;for(p=o.length;m<p;m++){d=o[m];k=function(){var t,v,r,h;r=f.attr_names;h=[];t=0;for(v=r.length;t<v;t++){a=r[t];b=d.attrs[a];h.push(b!=null?b.length>1?"<td><table><tbody><tr><td>"+b.join("</td><td>")+"</td></tr></tbody></table></td>":"<td>"+b.join("")+"</td>":"<td></td>")}return h}();l.push("<tr><td>"+d.name+"</td>"+k.join("")+"</tr>")}return l}();$("#query_results_table > thead").html("<tr><th>Item Name</th>"+
e.join("")+"</tr>");$("#query_results_table > tbody").html(c.join(""));return $("#query_btn").button("reset")}};query=function(f){var a;if(f==null)f=null;a=$("#query_expr").val();sdb.select(a,handle_query,f);return $("#query_btn").button("loading")};
metadata=function(f){return sdb.domain_metadata(f,function(a){console.log("metadata",a);$("#domain_metadata_label").html("<h2>"+f+" <small>Metadata</small></h2>");$("input[name=itemCount]").val(a.item_count);$("input[name=itemNamesSizeBytes]").val(a.item_names_size_bytes);$("input[name=attributeNameCount]").val(a.attribute_name_count);$("input[name=attributeNamesSizeBytes]").val(a.attribute_names_size_bytes);$("input[name=attributeValueCount]").val(a.attribute_value_count);$("input[name=attributeValuesSizeBytes]").val(a.attribute_values_size_bytes);
return $("#domain_metadata_modal").modal("show")})};save_domain=function(){var f;f=$("#domain_name").val();sdb.create_domain(f,update_domains_table);return $("#create_domain_modal").modal("hide")};cancel_domain=function(){return $("#create_domain_modal").modal("hide")};})();
