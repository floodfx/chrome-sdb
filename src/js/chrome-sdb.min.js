...
$(function(){$("#domain_table_div").height($(window).height()-200);console.log($("#domain_table_div").height());return $(window).resize(function(){$("#domain_table_div").height($(this).height()-200);return console.log($("#domain_table_div").height())})});
