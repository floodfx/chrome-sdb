(function(){var SHA1;
SHA1=function(){var b,a,c,d,f,e,k,o,p,n,l,s,u,r;d={};n=function(j){return b(a(k(j),j.length*8))};p=function(j,h){var i,g,q,m;i=k(j);if(i.length>16)i=a(i,j.length*8);q=Array(16);m=Array(16);for(g=0;g<16;g++){q[g]=i[g]^909522486;m[g]=i[g]^1549556828}i=a(q.concat(k(h)),512+h.length*8);return b(a(m.concat(i),672))};o=function(j,h){var i,g,q,m,t;if(h==null)h=true;i=h?"0123456789abcdef":"0123456789ABCDEF";q="";g=0;for(t=j.length;0<=t?g<t:g>t;0<=t?g++:g--){m=j.charCodeAt(g);q+=i.charAt(m>>>4&15)+i.charAt(m&
...
A);m=l(m,B);t=l(t,C)}return Array(i,g,q,m,t)};s=function(j,h,i,g){return j<20?h&i|~h&g:j<40?h^i^g:j<60?h&i|h&g|i&g:h^i^g};u=function(j){return j<20?1518500249:j<40?1859775393:j<60?-1894007588:-899497514};l=function(j,h){var i;i=(j&65535)+(h&65535);return(j>>16)+(h>>16)+(i>>16)<<16|i&65535};c=function(j,h){return j<<h|j>>>32-h};d.hex_sha1=function(j){return o(n(r(j)))};d.b64_sha1=function(j){return e(n(r(j)))};d.any_sha1=function(j,h){return f(n(r(j)),h)};d.hex_hmac_sha1=function(j,h){return o(p(r(j),
...
a).text(),box_usage:parseFloat($("BoxUsage",a).text()),status:c,req_url:d}}};b.prototype.ajax_request=function(a,c,d,f){if(d==null)d="GET";if(f==null)f=this.error_callback;return $.ajax({type:d,url:a,success:function(e,k){return c(b.parse_metadata(e,k,a),e)},error:function(e,k){var o;o=b.parse_metadata(e.responseXML,k,a);o.error={msg:$("Message",e.responseXML).text(),code:$("Code",e.responseXML).text()};return f(o,e.responseXML)},dataType:"xml"})};b.prototype.list_domains=function(a,c,d){var f,e;
if(a==null)a=this.default_callback;if(c==null)c=100;if(d==null)d=null;if(__indexOf.call(function(){e=[];for(f=1;f<=100;f++)e.push(f);return e}.apply(this),c)<0)throw"Max domains must be between 1 and 100";c={MaxNumberOfDomains:c};if(d)c.NextToken=d;return this.ajax_request(this.build_request_url("ListDomains",c),function(k,o){var p;p=[];$("DomainName",o).each(function(){return p.push($(this).text())});k.domains=p;k.next_token=$("NextToken",o).text();return a(k)})};b.prototype.domain_metadata=function(a,
...
d.attribute_values_size_bytes=parseInt($("AttributeValuesSizeBytes",f).text());d.timestamp=$("Timestamp",f).text();return c(d)})};b.prototype.select=function(a,c,d){if(c==null)c=this.default_callback;if(d==null)d=null;a={SelectExpression:a};if(d)a.NextToken=d;return this.ajax_request(this.build_request_url("Select",a),function(f,e){var k,o,p;p=[];o={};$("Item",e).each(function(){var n;n={attrs:{},name:$("Name:first",$(this)).text()};$("Attribute",$(this)).each(function(){var l,s;l=$("Name",$(this)).text();
o[l]=l;s=$("Value",$(this)).text();n.attrs[l]||(n.attrs[l]=[]);return n.attrs[l].push(s)});return p.push(n)});f.items=p;f.attr_names=function(){var n;n=[];for(k in o)n.push(k);return n}();d=$("NextToken",e).text();if(d!=="")f.next_token=d;return c(f)})};b.prototype.get_attributes=function(a,c,d,f){var e;if(d==null)d=this.default_callback;if(f==null)f=[];c={DomainName:a,ItemName:c};a=0;for(e=f.length;0<=e?a<e:a>e;0<=e?a++:a--)c["AttributeName."+a]=f[a];return this.ajax_request(this.build_request_url("GetAttributes",
c),function(k,o){var p;k.error!=null&&d(k);p={};$("Attribute",o).each(function(){var n,l;n=$("Name",$(this)).text();l=$("Value",$(this)).text();p[n]||(p[n]=[]);return p[n].push(l)});k.attributes=p;return d(k)})};b.prototype.put_attributes=function(a,c,d,f){var e,k,o,p,n,l,s;if(f==null)f=this.default_callback;k={DomainName:a,ItemName:c};p=c=0;for(l=d.length;p<l;p++){a=d[p];e=a.values;n=0;for(s=e.length;n<s;n++){o=e[n];k["Attribute."+c+".Name"]=a.name;k["Attribute."+c+".Value"]=o;if(a.replace&&a.replace===
true)k["Attribute."+c+".Replace"]=true;c+=1}}return this.ajax_request(this.build_request_url("PutAttributes",k),function(u){return f(u)})};b.prototype.delete_attributes=function(a,c,d,f){var e,k,o,p,n,l,s;if(f==null)f=this.default_callback;k={DomainName:a,ItemName:c};p=c=0;for(l=d.length;p<l;p++){a=d[p];if(e=a.values){n=0;for(s=e.length;n<s;n++){o=e[n];k["Attribute."+c+".Name"]=a.name;k["Attribute."+c+".Value"]=o;c+=1}}else{k["Attribute."+c+".Name"]=a.name;c+=1}}return this.ajax_request(this.build_request_url("DeleteAttributes",
k),function(u){return f(u)})};b.prototype.batch_delete_attributes=function(a,c,d){var f,e,k,o,p,n,l,s,u,r,j;if(d==null)d=this.default_callback;o={DomainName:a};a=0;for(r=c.length;0<=r?a<r:a>r;0<=r?a++:a--){f=c[a];e=f.item_name;o["Item."+a+".ItemName"]=e;e=0;j=f.item_attrs;n=0;for(s=j.length;n<s;n++){f=j[n];if(k=f.values){l=0;for(u=k.length;l<u;l++){p=k[l];o["Item."+a+".Attribute."+e+".Name"]=f.name;o["Item."+a+".Attribute."+e+".Value"]=p;e+=1}}else{o["Item."+a+".Attribute."+e+".Name"]=f.name;e+=1}}}return this.ajax_request(this.build_request_url("BatchDeleteAttributes",
o),function(h){return d(h)})};b.prototype.batch_put_attributes=function(a,c,d){var f,e,k,o,p,n,l,s,u,r,j;if(d==null)d=this.default_callback;o={DomainName:a};a=0;for(r=c.length;0<=r?a<r:a>r;0<=r?a++:a--){f=c[a];e=f.item_name;o["Item."+a+".ItemName"]=e;e=0;j=f.item_attrs;n=0;for(s=j.length;n<s;n++){f=j[n];k=f.values;l=0;for(u=k.length;l<u;l++){p=k[l];o["Item."+a+".Attribute."+e+".Name"]=f.name;o["Item."+a+".Attribute."+e+".Value"]=p;if(f.replace&&f.replace===true)o["Item."+a+".Attribute."+e+".Replace"]=
true;e+=1}}}return this.ajax_request(this.build_request_url("BatchPutAttributes",o),function(h){return d(h)})};b.prototype.create_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("CreateDomain",{DomainName:a}),function(d){return c(d)})};b.prototype.delete_domain=function(a,c){if(c==null)c=this.default_callback;return this.ajax_request(this.build_request_url("DeleteDomain",{DomainName:a}),function(d){return c(d)})};return b}();var Storage;
...
add_domains=function(b){var a,c,d,f,e;if(b.length===0){a="<tr><td>No domains in this region</td></tr>";return $("#domains_table > tbody").html(a)}else{$("#domains_table > tbody").html("");f=0;for(e=b.length;f<e;f++){d=b[f];c=$('<button id="metadata_'+d+'" class="btn info">metadata</a>');c.click(function(){return metadata(d)});a=$('<button id="delete_'+d+'" class="btn" disabled="disabled" style="margin-left:5px">delete</button>');a.click(function(){return confirm_delete(d)});a=$("<td>"+d+"<br /></td>").append(c).append(a);
a=$("<tr></tr>").append(a);$("#domains_table > tbody").append(a)}$("#domain_select > option").remove();a=[];f=0;for(e=b.length;f<e;f++){d=b[f];a.push($("#domain_select").append($("<option>",{value:d}).text(d)))}return a}};update_domains_table=function(b){if(b==null)b=null;return sdb.list_domains(function(a){add_domains(a.domains);if(b!=null)return b()})};
...
handle_query=function(b){var a,c,d,f,e,k,o,p,n;$("#message_box").hide();e=b.items.length;k=b.next_token;if(k!=null){k=k.replace(/\n/g,"");$("#next_page_btn").removeAttr("disabled").click(function(){return query(k)})}else $("#next_page_btn").attr("disabled","disabled").unbind("click");if(e===0){$("#query_results_table > thead").html("<tr><th>Items</th></tr>");$("#query_results_table > tbody").html("<tr><td>No results...</td></tr>")}else{e=function(){var l,s,u,r;u=b.attr_names;r=[];l=0;for(s=u.length;l<
s;l++){a=u[l];r.push("<th>"+a+"</th>")}return r}();$("#query_results_table > thead").html("<tr><th></th><th>Item Name</th>"+e.join("")+"</tr>");$("#query_results_table > tbody").html("");n=b.items;e=0;for(p=n.length;e<p;e++){f=n[e];o=function(){var l,s,u,r;u=b.attr_names;r=[];l=0;for(s=u.length;l<s;l++){a=u[l];c=f.attrs[a];r.push(c!=null?c.length>1?'<td data-attr-name="'+a+'" data-attr-multivalued="true"><table class="multivalued"><tbody><tr><td>'+c.join("</td></tr><tr><td>")+"</td></tr></tbody></table></td>":
'<td data-attr-name="'+a+'" data-attr-multivalued="false">'+c.join("")+"</td>":'<td data-attr-name="'+a+'" data-attr-multivalued="false"></td>')}return r}();d=$('<td class="delete">x</td>').click(function(){return confirm_delete_item($(this).closest("tr").attr("data-item-name"))});d=$("<tr></tr>").attr("data-item-name",f.name).append(d).append("<td>"+f.name+"</td>").append(o.join(""));$("#query_results_table > tbody").append(d)}$("#query_results_table > tbody > tr").each(function(l,s){return $(s).children("td").each(function(u,
